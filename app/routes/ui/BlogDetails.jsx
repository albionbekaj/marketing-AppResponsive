...
function BlogDetails() {
  return (
    <div className=" w-48 h-[300px] md:w-[227px] md:h-[330px] xl:w-[327px] xl:h-[421px] flex flex-col mt-4 pt-2 text-left bg-[#ffffff]">
      <img
        src={photo}
        alt="bg"
      ...
      <p className=" text-sm xl:text-lg p-2 md:pl-3.5 xl:pl-4 text-[#00000091]">
        Et vel ornare fusce bibendum cras et odio cras. Nunc nullam ultricies.
      </p>
